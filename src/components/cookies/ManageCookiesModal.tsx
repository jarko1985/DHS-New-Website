  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="text-sm text-[#e47a5a] hover:underline underline mt-2 cursor-pointer">
          Manage cookies
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
        <Dialog.Overlay className="bg-black/50 fixed inset-0 z-50" />
        <Dialog.Content className="fixed bottom-0 right-0 top-0 z-50 w-full max-w-md overflow-y-auto border-l border-gray-200 bg-blue-whale p-6 shadow-xl sm:rounded-l-lg">
          <div className="flex gap-x-2 items-center mb-6">
            ...
            <Dialog.Title className="text-xl font-bold text-[#e47a5a]">
              Manage Cookies
            </Dialog.Title>
          </div>
          ...
          <div className="mt-8 pt-4 border-t border-gray-200">
            ...
            <div className="flex justify-between gap-2">
              <Button
                onClick={acceptAll}
                variant="outline"
                className="bg-white text-blue-whale hover:bg-green-500 px-4 py-2 rounded-md cursor-pointer"
              >
                Accept All
              </Button>
              <Dialog.Close asChild>
                <Button
                  ...
                  className="bg-white hover:bg-green-500 text-blue-whale px-4 py-2 rounded-md cursor-pointer"
                >
                  Confirm Preferences
                </Button>
              </Dialog.Close>
